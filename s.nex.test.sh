...
export O_NEX_MOVE_ENABLED=0
sh s.nuke.sh
python3 o.node.py --node body --model_api rep --robot nex &
python3 o.node.py --node look --model_api rep &
python3 o.node.py --node plan --model_api rep &
python3 o.node.py --node talk --model_api rep
